...
(async () => {
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            ...
            [
                '#body-login > div > div > main > form > div.buttons > input'
            ],
            [
                'xpath///*[@id="body-login"]/div/div/main/form/div[2]/input'
            ],
            [
                'text/Install'
            ]
    ...
    }
    {
        ...
        await scrollIntoViewIfNeeded([
            [
                '#body-login > div.wrapper > div > main > div > div.dialog-row > button > span > span'
            ],
            [
                'xpath///*[@id="body-login"]/div[1]/div/main/div/div[8]/button/span/span'
            ],
            [
